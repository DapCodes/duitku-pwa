...
export const homeView = {
      ...
      <div class="px-6 pt-12 pb-8 bg-surface-bright relative overflow-hidden mb-2">
        ...
        <div class="relative z-10 flex justify-between items-center mb-8">
          <div class="flex items-center gap-4">
            <button id="btn-settings" class="w-14 h-14 shrink-0 clay-surface rounded-full flex items-center justify-center cursor-pointer transition-transform active:scale-95 p-1">
        ...
        <div class="clay-surface p-6 flex flex-col items-center justify-center relative overflow-hidden">
          <div class="absolute -top-10 -right-10 w-32 h-32 bg-primary-container opacity-20 rounded-full"></div>
          <p class="text-xs font-bold uppercase tracking-widest text-outline mb-2">Saldo Saat Ini</p>
          <h2 class="text-4xl font-black text-primary tracking-tight" id="home-balance">Rp 0</h2>
        </div>
      </div>

      <!-- Main Content -->
      <div class="px-6 relative z-20 space-y-6 pt-2">
        ...
        <!-- Financial Mood -->
        <div class="clay-surface p-5 flex flex-col gap-3 relative overflow-hidden">
        ...
        <!-- Prediction -->
        <div class="clay-surface-sm p-5 bg-gradient-to-br from-surface to-surface-container flex flex-col gap-1 relative overflow-hidden">
        ...
        <!-- Daily Insight -->
        <div class="clay-surface p-5 border border-primary/20 bg-primary/5">
  ...
  init: async () => {
    ...
    if (user) {
      ...
      document.getElementById('home-balance').textContent = formatRupiah(currentBalance);
      if (user.photo) {
          ...
          goalsHTML += `
            <div class="min-w-[240px] w-[240px] clay-surface rounded-[24px] p-4 flex flex-col gap-3 snap-center shrink-0 cursor-pointer active:scale-95 transition-transform nav-btn" data-nav="goalDetail" data-id="${goal.id}">
               ...
               <div>
                 ...
                 <p class="font-label-sm text-on-surface-variant">Rp ${formatRupiah(goal.target_amount)}</p>
               </div>
               ...
               <div class="flex justify-between items-center">
                 <p class="font-label-sm text-on-surface-variant text-[10px]">Terkumpul Rp ${formatRupiah(goal.current_amount)}</p>
